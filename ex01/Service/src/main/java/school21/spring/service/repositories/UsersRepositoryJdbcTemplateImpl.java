...
public class UsersRepositoryJdbcTemplateImpl implements UsersRepository {
    ...
    public void save(User entity) {
        jdbcTemplate.update("INSERT INTO service.users (email) VALUES (?)", entity.getEmail());
    }

    @Override
    public void update(User entity) {
        jdbcTemplate.update("UPDATE service.users SET email = ? WHERE identifier = ?", entity.getEmail(), entity.getIdentifier());
    }
